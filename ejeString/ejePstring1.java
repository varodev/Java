...
//c) Partiendo de la cadena anterior y usando los métodos de StringBuilder modificar la cadena para que pase a ser "Hay Caracolas" y mostrarla.
...
//d) Partiendo de la cadena anterior y usando los métodos de StringBuilder modificar la cadena para que pase a ser "Hay 5000 Caracolas" y mostrarla.
    	s.insert(s.indexOf("Caracolas"), " 5000 ");
    	System.out.println(s);
//e) Partiendo de la cadena nterior y usando los métodos de StringBuilder modificar la cadena para que pase a ser "Hay 5000 Caracolas en el mar" y mostrarla
    	s.append(" en el mar");
    	System.out.println(s);
	}//main
}//ejePstring1
