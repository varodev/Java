...
public class Coche {
		...
		public Coche(String ciudad, String matricula, String provincia,
				int tipoMotor) {
		...
		public Coche(String ciudad) {
			
			this.ciudad = ciudad;
		}
		public Coche (String valorMatricula, String valorProvincia, int valorTipoMotor) {
	        ciudad = "Madrid";
