...
import java.util.*;
public class E1Taxi{
	private E1Coche taxi1;//declaración global del objeto taxi1 de la clase Coche
	private E1Coche taxi2; ;//declaración global del objeto taxi2 de la clase Coche

	      Scanner teclado=new Scanner(System.in);
	public static void main(String[] args) {
		E1Taxi obj=new E1Taxi();// para no declarar los metodos y variables globales static
	      obj.cargarDatos();
	      obj.muestraDatos();
	}
	...
	private void cargarDatos(){
	      ...
	      taxi1=new E1Coche(ciudad,matricula,provincia, tipoMotor);
	      taxi2=new E1Coche(matricula,provincia, tipoMotor);
	}
