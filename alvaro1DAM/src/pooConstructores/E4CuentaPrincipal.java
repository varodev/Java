...
import java.util.*;
public class E4CuentaPrincipal {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			...
			E4Cuenta cuenta2 = new E4Cuenta("Juan Ferrández Rubio", "12345678901234567890", 1.75, 300);

			//se crea cuenta3 como copia de cuenta1
			//se ejecuta el constructor copia
			E4Cuenta cuenta3 = new E4Cuenta(cuenta1);
